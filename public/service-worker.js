// Service Worker for House of Chin Fe Web App
// Handles push notifications and offline functionality

const CACHE_NAME = 'house-of-chin-fe-cache-v1';
...
self.addEventListener('push', event => {
  ...
  try {
    ...
    data = {
      ...
      body: 'Something new happened at House of Chin Fe.',
      icon: '/icons/icon-192.png'
    };
  }
  
  const title = data.title || 'House of Chin Fe';
  const options = {
    body: data.body || 'New notification from House of Chin Fe',
    icon: data.icon || '/icons/icon-192.png',
    badge: data.badge || '/icons/badge-96.png',
    tag: data.tag || 'house-of-chin-fe-notification',
    data: data.data || {},
