            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#E42423] focus:border-[#E42423] sm:text-sm transition-all duration-200"
                />
            ...
            <div className="p-5 space-y-5">
              <div className="bg-gray-50 p-4 rounded-md border border-gray-100">
                ...
                <input
                  ...
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#E42423] focus:border-[#f45a59] sm:text-sm transition-all duration-200"
                />
                  ...
                  <label className="block mt-2">
                    ...
                    <input
                      ...
                      className="mt-1 block w-full cursor-pointer text-sm
                                ...
                                file:rounded file:border-0
                                file:text-sm file:font-semibold
                                file:bg-[#f45a59] file:text-white
                                hover:file:bg-[#f45a59]"
                    />
                  </label>
                </div>
