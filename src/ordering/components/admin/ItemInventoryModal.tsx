          ...
          {enableTracking && (
            <>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  className="bg-[#E42423] hover:bg-[#a97c28] text-white py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-[#c1902f] focus:ring-opacity-50"
