            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">
                  <Mail className="inline-block w-4 h-4 mr-1 text-[#E42423]" />
                ...
                <input
                  ...
                  className="
                    ...
                    focus:outline-none focus:ring-2 focus:ring-[#E42423] focus:border-transparent
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-1">
                  <Lock className="inline-block w-4 h-4 mr-1 text-[#E42423]" />
              ...
              <button
                ...
                className="
                  ...
                  hover:bg-[#f45a59] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E42423]
